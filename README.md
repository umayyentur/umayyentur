...
<h3 align="center">Healthcare ML / NLP Engineer from Turkey</h3>
...
- 🔬 **Building clinical NLP pipelines for oncology real-world evidence — treatment-line detection, biomarker & comorbidity extraction from Turkish clinical notes**

- 🧠 **Working with LLMs, transformers, and spaCy to turn unstructured medical text into structured registry data**

- 🛠 **Full-stack precision-medicine tooling: Flask + PostgreSQL/pgvector dashboards for patient registries and clinical trial matching**

- 🌱 **Currently exploring agentic workflows, semantic search, and LLM-driven clinical reasoning**
...
<a href="https://spacy.io/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/explosion/spaCy/master/website/src/images/icon.png" alt="spacy" width="40" height="40"/> </a>
